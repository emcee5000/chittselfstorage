...
jQuery(document).ready(function($){
	...
	// Custom functions for custom post types
	
	$("#home-page .type-offer").hide();
	$("#home-page .type-page").hide();
	$("#home-page .type-sales_letter").hide();
	$("#home-page .type-squeeze").hide();
	
	var selected_home_layout = $('#home_layout').val();
	
	if( selected_home_layout != 0 )
	{
		$('#home-page .type-' + selected_home_layout ).fadeIn();
	}
	...
	$('#home_layout').on(
		...
		function home_layout_change()
		{
			...
			if( new_selection != 0 )
			{
				$('#home-page .type-' + new_selection ).fadeIn();
			}
	...
	// $('#container-brands2').hide();
	// $('a#another').on('click', function() {
	// 	$('#container-brands2').show();
	// });
