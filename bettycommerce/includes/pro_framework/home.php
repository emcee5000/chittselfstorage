<?php if ( is_user_logged_in() ):?>
	...
	<div id="upthemes_framework" class="wrap">
		...
		<div class="button-zone-wrapper zone-top">
			...
			<span class="top">
			    <span class="formState"><?php _e("Theme options have changed. Make sure to save.", PA_TEXTDOMAIN); ?></span>
			    <button class="save" id="up_save" name="up_save" type="submit"><?php _e("Save Changes", PA_TEXTDOMAIN); ?></button>
			    <button class="button" type="reset"><?php _e("Discard Changes", PA_TEXTDOMAIN); ?></button>
			</span>
		    </div><!-- .button-zone -->
		...
		<div id="up_main">
					...
					<div id="up_nav" class="box">
						...
						<ul>
							...
							global $up_tabs;
								...
								<?php endforeach;
							    endforeach;?>
							<li class="import-export"><a href="#import-export"><?php _e("Import/Export", PA_TEXTDOMAIN); ?></a></li>
						</ul>
				...
				<div id="up_content">
					<div id="tabber">
						...
						<h3><?php _e("Import/Export", PA_TEXTDOMAIN); ?></h3>
						<ul class="feature-set">
						    <?php require_once (THEME_PATH . '/includes/pro_framework/import-export.php'); ?>
						</ul>										
					    </div><!-- /#import-export -->
		...
		<div id="up_footer">
			...
			<ul>
				<li><?php echo UPTHEMES_NAME?> <?php _e("Version", PA_TEXTDOMAIN); ?> <?php echo UPTHEMES_THEME_VER; ?></li>
				<li><?php _e("Pro Framework Version", PA_TEXTDOMAIN); ?> <?php echo UPTHEMES_VER; ?></li>
			</ul>
...
<?php else: _e("You must be logged in to view this page", PA_TEXTDOMAIN); endif;?>