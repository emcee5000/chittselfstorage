...
?>
                ...
                <li class="type-<?php echo $value['type'];?>" id="<?php echo $value['id']; ?>_list">
                    ...
                    <script type="text/javascript">
                        jQuery(function(){
                            jQuery('#<?php echo $value['id']; ?>_list p.add_text_list a').live('click', function(){
                                jQuery(this).parents('li').find('div.text_list').append('<div class="entry"><input class="text_list" type="text" name="<?php echo $value['id']; ?>[]" /><p class="delete_text_list"><a href="#"><img src="<?php echo THEME_DIR;?>/includes/pro_framework/images/upfw_ico_delete.png" alt="Delete Text Field" /></a></p></div><div class="clear"></div>');
                    ...
                    <fieldset class="data">
                        <div class="inner">
                            <div class="text_list">
                                <?php $add_text = $value['default_text'] ? $value['default_text'] : __('Add New Field', PA_TEXTDOMAIN);?>
                                    ...
                                    if(is_array($up_options->$value['id'])):
                                        foreach($up_options->$value['id'] as $text):?>
                                            <div class="entry">
                                                ...
                                                <p class="delete_text_list"><a href="#"><img src="<?php echo THEME_DIR; ?>/includes/pro_framework/images/upfw_ico_delete.png" alt="Delete Text Field" /></a></p>
                                                <div class="clear"></div>
                                            </div>
                                        <?php endforeach;
                                    endif;
                    ...
                    <fieldset class="data">
                        <div class="inner">
                            <span class="colorPickerWrapper">
                                <a href="#" class="clear"><img src="<?php echo THEME_DIR; ?>/includes/pro_framework/images/upfw_ico_delete.png" alt="Delete Text Field" /></a>
...
?>
                ...
                <script type="text/javascript">
					jQuery(document).ready(function($){
                        ...
                        jQuery("#container-<?php echo $value['id']; ?>").find('a.clear').live('click', function(e){
                    		...
                    		e.preventDefault();
							jQuery('#<?php echo $value['id']; ?>preview').html('<img src="<?php echo THEME_DIR; ?>/includes/pro_framework/images/upfw_noimage.gif" alt="No Image" />');
                        ...
                        new AjaxUpload(<?php echo $value['id']; ?>, {
                            action: '<?php echo THEME_DIR; ?>/includes/pro_framework/upload-file.php',
				...
				<div class="inner">
		            <label for="<?php $value; ?>"><?php echo $value['name']; ?></label>
		            <?php if($value['desc']): ?><kbd><?php echo $value['desc']; ?></kbd><?php endif;?>
		        </div>
		
				<?php $arr = $value['number']; ?>
				
				<?php for ( $i = 1; $i <= $arr; $i++ ) { ?>
				
				<?php $value = $value['id'].$i; echo $value; ?>
				
				<?php 
				include('option-image.php');
				?>
                ...
                <li class="type-<?php echo $value['type'];?>" id="container-<?php echo $value['id'];?>">
                    <fieldset class="title">
                        ...
                        if($up_options->$value['id']):
                        	...
                        	echo "<img src='".THEME_DIR."/includes/pro_framework/images/upfw_noimage.gif' alt='No Image Available' />";
                        	echo "</div>";
	                        echo '<a href="#" class="clear" style="display: none;"><img src="' . THEME_DIR . '/includes/pro_framework/images/upfw_ico_delete.png" alt="' . __("Delete Text Field", PA_TEXTDOMAIN) . '" /></a>';
	                    endif;?>
...
function upfw_typography($value,$attr){
    ...
    <li class="type-<?php echo $value['type'];?> typography" id="container-<?php echo $value['id']; ?>">
                	...
                	<fieldset>
	                    ...
	                    <div class="field">
	                        ...
	                        <?php if(is_array($fonts)): ksort($fonts);?>
	                            ...
	                            <p><?php _e('No fonts registered yet', PA_TEXTDOMAIN);?></p>
	                        <?php endif;?>
						</div>
						...
						<div class="field">
	                        ...
	                        <select id="<?php echo $value['id']; ?>_fontweight" name="<?php echo $value['id']; ?>[fontweight]">
                                ...
                                if(!$weights):?>
                                    <option value="normal" <?php if($fontweight=='normal') echo "selected";?>><?php _e("Normal", PA_TEXTDOMAIN); ?></option>
                                    <!--<option value="bold" <?php //if($fontweight=='bold') echo "selected";?>><?php //_e("Bold", PA_TEXTDOMAIN); ?></option>-->
						...
						<div class="field">
	                        ...
	                        <select id="<?php echo $value['id']; ?>_fontweight_faux" name="<?php echo $value['id']; ?>[fontweight_faux]">
                                ...
                                <option value="normal" <?php if($fontweight_faux=='normal') echo "selected";?>><?php _e("Normal", PA_TEXTDOMAIN); ?></option>
                                <option value="bold" <?php if($fontweight_faux=='bold') echo "selected";?>><?php _e("Bold", PA_TEXTDOMAIN); ?></option>
	                        </select>
						...
						<div class="field">
	                        ...
	                        <select id="<?php echo $value['id']; ?>_textshadow" name="<?php echo $value['id']; ?>[textshadow]">
	                            <option value="none" <?php if($textshadow=='none') echo "selected";?>><?php _e("No Shadow", PA_TEXTDOMAIN); ?></option>
	                            <option value="3px 3px 0 rgba(0,0,0,0.1)" <?php if($textshadow=='3px 3px 0 rgba(0,0,0,0.1)') echo "selected";?>><?php _e("Style #1", PA_TEXTDOMAIN); ?></option>
	                            <option value="1px 1px 4px rgba(0,0,0,0.3)" <?php if($textshadow=='1px 1px 4px rgba(0,0,0,0.3)') echo "selected";?>><?php _e("Style #2", PA_TEXTDOMAIN); ?></option>
	                            <option value="0 1px 0 rgba(255,255,255,1)" <?php if($textshadow=='0 1px 0 rgba(255,255,255,1)') echo "selected";?>><?php _e("Style #3", PA_TEXTDOMAIN); ?></option>
	                            <option value="2px -2px 0 rgba(0,0,0,0.2)" <?php if($textshadow=='2px -2px 0 rgba(0,0,0,0.2)') echo "selected";?>><?php _e("Style #4", PA_TEXTDOMAIN); ?></option>
	                            <option value="-2px 2px 0 rgba(0,0,0,0.2)" <?php if($textshadow=='-2px 2px 0 rgba(0,0,0,0.2)') echo "selected";?>><?php _e("Style #5", PA_TEXTDOMAIN); ?></option>
	                            <option value="3px 0 0 rgba(0,0,0,0.2)" <?php if($textshadow=='3px 0 0 rgba(0,0,0,0.2)') echo "selected";?>><?php _e("Style #6", PA_TEXTDOMAIN); ?></option>
	                            <option value="0 2px 0 rgba(0,0,0,0.2)" <?php if($textshadow=='0 2px 0 rgba(0,0,0,0.2)') echo "selected";?>><?php _e("Style #7", PA_TEXTDOMAIN); ?></option>
	                        </select>
					...
					<fieldset>
						...
						<div class="field">
	                        ...
	                        <select id="<?php echo $value['id']; ?>_texttransform" name="<?php echo $value['id']; ?>[texttransform]">
	                            <option value="none"><?php _e("None", PA_TEXTDOMAIN); ?></option>
	                            <option value="uppercase" <?php if($texttransform=='uppercase') echo "selected";?>><?php _e("uppercase", PA_TEXTDOMAIN); ?></option>
	                            <option value="lowercase" <?php if($texttransform=='lowercase') echo "selected";?>><?php _e("lowercase", PA_TEXTDOMAIN); ?></option>
	                            <option value="capitalize" <?php if($texttransform=='capitalize') echo "selected";?>><?php _e("capitalize", PA_TEXTDOMAIN); ?></option>
	                        </select>
						</div>
						...
						<div class="field">
	                        ...
	                        <select id="<?php echo $value['id']; ?>_fontstyle" name="<?php echo $value['id']; ?>[fontstyle]">
	                            <option value="normal"><?php _e("Normal", PA_TEXTDOMAIN); ?></option>
	                            <option value="italic" <?php if($fontstyle=='italic') echo "selected";?>><?php _e("Italic", PA_TEXTDOMAIN); ?></option>
	                            <option value="oblique" <?php if($fontstyle=='oblique') echo "selected";?>><?php _e("Oblique", PA_TEXTDOMAIN); ?></option>
	                        </select>
						</div>
	                   ...
	                   <div class="field">
	                        ...
	                        <select id="<?php echo $value['id']; ?>_textdecoration" name="<?php echo $value['id']; ?>[textdecoration]">
	                            <option value="none"><?php _e("None", PA_TEXTDOMAIN); ?></option>
	                            <option value="underline"<?php if($textdecoration=='underline') echo "selected";?>><?php _e("underline", PA_TEXTDOMAIN); ?></option>
	                            <option value="line-through"<?php if($textdecoration=='line-through') echo "selected";?>><?php _e("line-through", PA_TEXTDOMAIN); ?></option>
	                            <option value="overline" <?php if($textdecoration=='overline') echo "selected";?>><?php _e("overline", PA_TEXTDOMAIN); ?></option>
	                        </select>
						</div>
        ...
        <div class="font-preview">
            <label class="font-preview-label"><?php _e('Preview', PA_TEXTDOMAIN);?></label>
            <div id="font-preview" class="<?php echo $value['id']; ?>_type_preview" style="font-family:<?php echo $fonts[$family]['font_family']; ?>; font-size: <?php echo $fontsize; ?>; font-style: <?php echo $fontstyle; ?>; letter-spacing: <?php echo $letterspacing;?>; line-height:<?php echo $lineheight;?>; text-transform:<?php echo $texttransform;?>; text-decoration:<?php echo $textdecoration;?>; font-weight:<?php echo $fontweight_faux;?>; text-shadow:<?php echo $textshadow; ?>; -moz-text-shadow:<?php echo $textshadow; ?>; -webkit-text-shadow:<?php echo $textshadow; ?>;  "><?php _e('Pack my box with five dozen liquor jugs.', PA_TEXTDOMAIN);?><br /><?php _e('The quick brown fox jumps over the lazy dog. ', PA_TEXTDOMAIN);?></div>
        </div>
                                ...
                                <div class="inner">
                                    ...
                                    <div class="up-style-container">
                                        ...
                                        if(is_array($up_styles)):
                                            ...
                                            echo "<p>".__('No styles are registered yet for this theme.', PA_TEXTDOMAIN)."</p>";
                                        endif;?>
                                    </div>
                                </div>
                            </fieldset>
