...
$options = array(
  array(
    'name' => 'Show Shipping Promotion in Header?',
    'desc' => 'Do you want to show a shipping promotion in the Header?',
    'id' => 'shipping_promo',
    'type' => 'select',
    'value' => 'Yes',
    'default_text' => 'Yes',
  ...
  array(
    'name' => 'Shipping Promotion Text',
    'desc' => 'Change the text of the shipping promo.',
