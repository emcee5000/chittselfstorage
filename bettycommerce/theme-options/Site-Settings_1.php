...
$options = array(
    array(
        'name' => 'Custom Logo',
        'desc' => 'Upload a custom image as your logo.',
        'id' => 'custom_logo',
        'type' => 'image',
    ...
    array(	
    	"name" => "Custom Favicon",
    	"desc" =>"Upload a 16px x 16px PNG/JPG image.",
    	"id" => "custom_favicon",
    	"type" => "image",
    	"value" => "Upload Custom Favicon"
    ),
    array(
      'name' => 'Display Search Bar in Header',
      'desc' => 'Do you want to display the Search bar in Header?',
      'id' => 'header_search',
      'type' => 'select',
      'value' => 'Yes',
      'default_text' => 'Yes',
    ...
    array(
      ...
      'desc' => 'Change the copyright information in the footer.',
      'id' => 'copyright_footer',
      'type' => 'textarea'
    ),
);
